...
const QuioscoProvider = ({children}) => {
    ...
    useEffect(()=>{
        const calculoTotal = pedido.reduce((total, producto)=> (producto.precio * producto.cantidad) + total, 0)
        ...
        if(pedido.length === 0) {
            ...
            try {
                const respuesta = await fetch('/api/ordenes', {method: 'POST',
                  ...
                  body: JSON.stringify({pedido, nombre, total, fecha: Date.now().toString()})
                })
